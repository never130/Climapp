 ...
 * @param {string} eventType event type ej, "click", "mouseover"
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        const {
            ...
            dt: dateUnix,
            sys: {
                sunrise: sunriseUnixUTC, sunset: sunsetUnixUTC
            },
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <div class="card card-sm slider-card">
                    ...
                    <img src="./asset/images/weather_icons/${icon}.png" width="48"
             ...
             */
            forecastSection.innerHTML = `
            <h2 class="title-2" id="forecast-label">5 Dias de Pronostico</h2>
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                <div class="icon-wrapper">
                    ...
                    height="36" alt="${description}" class="weather-icon" title="${description}">
